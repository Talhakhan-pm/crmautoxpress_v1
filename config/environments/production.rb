...
Rails.application.configure do
  ...
  # Mount Action Cable for real-time updates (Dialpad call status)
  config.action_cable.mount_path = '/cable'
  config.action_cable.url = "wss://crm.autoxpress.us/cable"
  config.action_cable.allowed_request_origins = [ 
    "https://crm.autoxpress.us", 
    /https:\/\/.*\.autoxpress\.us/,
    "https://crm.autoxpress.us"
  ]
  ...
  config.action_mailer.smtp_settings = {
    ...
    user_name: ENV['GMAIL_USERNAME'] || Rails.application.credentials.dig(:gmail, :username),
    password: ENV['GMAIL_PASSWORD'] || Rails.application.credentials.dig(:gmail, :password),
